...
class SimplePathTree(EquivalenceChecker):
    ...
    def __init__(self, boolean_function_a: BooleanFunction, boolean_function_b: BooleanFunction):
        ...
        for output_variable in self.boolean_function_b.get_output_variables():
    ...
    def _dfs_visit(self, graph: Graph, u: Any) -> bool:
        ...
        if output:
            for output_variable in output_variables:
                ...
                # print(sentence_a)
                # sentence_b = Z3Converter.verilog_to_z3(self.boolean_function_b.functions.get(output_variable).verilog)
                # # print(sentence_b)
    ...
    def is_equivalent(self, sampling_size: int = -1) -> bool:
        ...
        crossbar = self.boolean_function_a[0]
        ...
        for (input_function, (input_layer, input_nanowire)) in crossbar.get_input_nanowires().items():
            ...
            for output_function in crossbar.get_output_variables():
                ...
                sentence_b = Z3Converter.verilog_to_z3(self.boolean_function_b.functions.get(output_function).verilog)
